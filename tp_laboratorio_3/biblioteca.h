...
int subMenu2();
/**
 * @fn int Validate_CharConNumeros(char[])
 * @brief valida que la cadena sean solo numeros
 *
 * @param
 * @return retorna 1 si lo es y 0 sino lo es.
 */

int Validate_CharConNumeros(char []);
/**
 * @fn void Get_Char(char[], char[], char[])
 * @brief se pide el ingreso de la cadena y se la valida con la funcion validate_charConNumeros.
 *
 * @param
 * @param
 * @param
 */
void Get_CharConNumeros(char [],char [],char []);
